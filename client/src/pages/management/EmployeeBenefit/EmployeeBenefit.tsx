...
const config: ITableConfig = {
  ...
  permissions: {
    ...
    add: {
      ...
      popover: "Add new Employee Benefit",
    },
    delete: {
      isAllowed: true,
      placeholder: "Delete",
      popover: "Delete this Employee Benefit?",
    },
    update: {
      isAllowed: true,
      placeholder: "Edit",
      popover: "Update this Employee Benefit?",
    },
  },
};
...
const formGroupFields: IBaseFormGroupField[] = [
  ...
  },
  {
    ...
    field: {
      ...
      placeholder: "Input the Employee Benefit name",
    },
  },
  {
    name: "description",
    ...
    field: {
      type: "textarea",
      placeholder: "Input the Employee Benefit description",
...
export const EmployeeBenefit = () => {
  ...
  const [form, setForm] = useState({
    ...
    onAddFn: (data: DynamicObject) => addEmployeeBenefit(data as IEmployeeBenefitInput),
